Hello all! Most of the work that I was able to gather here is on training a non-linear neural network to learn data-assimilated solutions to the heat equation (pde)
